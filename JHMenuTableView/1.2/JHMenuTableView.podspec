#
#  Be sure to run `pod spec lint JHMenuTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Jiahai" => "xingjiahai@126.com" }
  # Or just: s.author    = "Jiahai"
  # s.authors            = { "Jiahai" => "xingjiahai@126.com" }
  # s.social_media_url   = "http://twitter.com/Jiahai"
  ...
  s.source_files  = "JHMenuTableView", "JHMenuTableView/*.{h,m}"
